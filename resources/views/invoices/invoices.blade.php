...
@section('content')
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu  tx-13">
                                                            ...
                                                            @can('تغير حالة الدفع')
                                                            <a class="dropdown-item btn btn-info mg-t-5 " href="{{ route('statuse_show',$Data->id) }}">تغير حاله الدفع</a>
                                                            @endcan
                                                            ...
                                                            @can('طباعةالفاتورة')
                                                            <a class="dropdown-item btn btn-info mg-t-5 " href="{{ route('Print_invoice',$Data->id) }}"> <i class="text-success fas fa-print"></i>&nbsp;&nbsp;طباعه الفاتوره</a>
                                                            @endcan
                ...
                <div class="modal fade" id="Transfer_invoice" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">أرشفه الفاتوره </h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                                <form action="{{route('invoices.destroy', 'test') }}" method="post">
