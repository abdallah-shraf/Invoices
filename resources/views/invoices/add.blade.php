...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">قائمه الفواتير</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ إضافه فاتوره</span>
						</div>
					</div>
                                ...
                                <form action="{{ route('invoices.store') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" name="invoice_Date" value="{{ date('Y-m-d') }}" placeholder="YYYY-MM-DD" class="form-control fc-datepicker" required>
                                        </div>


                                        <div class="form-group col-md-4">
                                            <label class="control-label" >تاريخ الأستحقاق</label>
                                            <input type="text" name="due_Date"  placeholder="YYYY-MM-DD" class="form-control fc-datepicker">
                                        </div>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control form-control-lg" id="Amount_Commission"
                                                name="Amount_Commission" title="يرجي ادخال مبلغ العمولة " oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" required>
                                        </div>
