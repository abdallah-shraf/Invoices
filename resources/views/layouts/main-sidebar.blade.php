<!-- main-sidebar -->
		...
		<aside class="app-sidebar sidebar-scroll">
			<div class="main-sidebar-header active">
				<a class="desktop-logo logo-light active" href="{{ url('/' . $page='home') }}"><img src="{{URL::asset('assets/img/brand/favicon.png')}}" class="main-logo" alt="logo"></a>
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='invoice_partial') }}">الفواتير المدفوعه جزئي</a></li>
                            @endcan

                            @can('الفواتير الغير مدفوعة')
							<li><a class="slide-item" href="{{ url('/' . $page='invoice_unPaid') }}">الفواتير الغير مدفوعه</a></li>
                            @endcan

                            @can('ارشيف الفواتير',)
                            <li><a class="slide-item" href="{{ url('/' . $page='Archef') }}">الارشيف</a></li>
                             @endcan
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            ...
                            @can('المنتجات')
							<li><a class="slide-item" href="{{ url('/' . $page='products') }}">المنتاجات </a></li>
                            @endcan
